...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <a type="button" class="btn btn-default"
           href="${pageContext.request.contextPath}/workbench/clue/toConvertView?id=${clue.id}">
    ...
    <c:forEach items="${clue.clueRemarks}" var="clueRemark">
        <div class="remarkDiv" style="height: 60px;">
            ...
            <div style="position: relative; top: -40px; left: 40px;">
                ...
                <font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}-${clue.company}</b> <small
                    style="color: gray;"> ${clue.createTime} ${clue.createBy}</small>
                <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
                    <a class="myHref"
                       onclick="updateClue($('#clueNoteContentH5${clueRemark.id}').html(),'${clueRemark.id}')"
            ...
            <table class="table table-hover" style="width: 900px;">
                ...
                <c:forEach items="${clue.activities}" var="activity">
                    <tr>
                        ...
                        <td><a onclick="unbind('${clue.id}','${activity.id}',$(this))" href="javascript:void(0)"
...
<script>
    ...
    $('#updateClueRemarkBtn').click(function () {
        $.ajax({
            url: '${pageContext.request.contextPath}/workbench/clue/updateClueRemark',
            data: {
                'id': $('#clueRemarkId').val(),
    ...
    $('#saveClueRemarkBtn').click(function () {
        $.ajax({
            url: '${pageContext.request.contextPath}/workbench/clue/saveClueRemark',
            data: {
                'clueId': '${clue.id}',
    ...
    function unbind(clueId, activityId, $this) {
        $.ajax({
            url: '${pageContext.request.contextPath}/workbench/clue/deleteBind',
            data: {
                'clueId': clueId,
    ...
    function deleteManyBind() {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/workbench/clue/deleteManyBind',
            data: {
                'clueId': '${clue.id}',
    ...
    $('#activityName').keypress(function (event) {
        ...
        if (event.keyCode == 13) {
            $.ajax({
                url: '${pageContext.request.contextPath}/workbench/clue/queryActivityExculdeNow',
                data: {
                    'clueId': '${clue.id}',
    ...
    function saveBindFun() {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/workbench/clue/saveBind',
            data: {
                'clueId': '${clue.id}',
                'activityIds': activityIds.join()
            },
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    //异步查询当前线索关联的所有市场活动
                    $.ajax({
                        url: '${pageContext.request.contextPath}/workbench/clue/queryClueActivity',
                        data: {
                            'clueId': '${clue.id}'
                        },
                        type: 'get',
