...
<body>
	...
	<form class="form-horizontal" action="${pageContext.request.contextPath}/workbench/transaction/saveTransaction" method="post" id="saveTransactionForm" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" name="expectedDate" class="form-control" id="create-expectedClosingDate">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" name="possibility" class="form-control" id="create-possibility" value="10">
			</div>
		</div>
...
<script>
	...
	$('#create-accountName').change(function () {
		// var $this = $(this);
		$.ajax({
			url : '${pageContext.request.contextPath}/workbench/transaction/queryCustomerByName',
			data : {
				name : $(this).val()
			},
			type : 'get',
