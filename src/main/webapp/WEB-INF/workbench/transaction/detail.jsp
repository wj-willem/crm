...
<!-- 阶段状态 -->
<div style="position: relative; left: 40px; top: -50px;" id="tranStageDiv">
    阶段&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    -----------
    <span class="glyphicon glyphicon-remove mystage" style="color: red" data-toggle="popover" data-placement="bottom" data-content="丢失的线索"></span>
    -----------
...
<div style="position: relative; top: 0px;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 20px;">
        ...
        <div style="width: 300px;position: relative; left: 650px; top: -60px;"><b id="stage">${transaction.stage}</b>
        </div>
        <div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
        <div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
    </div>
    <div style="position: relative; left: 40px; height: 30px; top: 30px;">
        ...
        <div style="width: 300px;position: relative; left: 650px; top: -60px;"><b
                id="possibility">${transaction.possibility.get(0)}</b></div>
        <div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
        <div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
    </div>
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 70px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>修改者&nbsp;&nbsp;</b><small
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 100px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${transaction.nextContactTime}</b>
        </div>
        ...
        <div class="remarkDiv" style="height: 60px;">
            ...
            <div style="position: relative; top: -40px; left: 40px;">
                ...
                <font color="gray">交易</font> <font color="gray">-</font> <b>${transaction.name}</b> <small
                    style="color: gray;"> ${transaction.expectedDate} ${transaction.createBy}</small>
...
<script>
    ...
    $.ajax({
        url: '${pageContext.request.contextPath}/workbench/transaction/stageList',
        data: {
    ...
    $('#tranStageDiv').on('click', 'span', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //动态修改当前交易对应的交易历史信息
                $('#transactionHistoryBody').html(transactionHistoryContent);
                //阶段提示框
                $(".mystage").popover({
                    trigger: 'manual',
                    placement: 'bottom',
