...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            window.open("${pageContext.request.contextPath}/toView/main/index", "workareaFrame");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="position: relative; left: 40px;">
                    姓名：<b>张三</b><br><br>
                    登录帐号：<b>${sessionScope.user.name}</b><br><br>
    ...
    <div class="modal-dialog" role="document" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" data-dismiss="modal"
                        onclick="window.location.href='${pageContext.request.contextPath}/settings/user/loginOut';">确定
                </button>
            </div>
        </div>
    </div>
        ...
        <ul>
            <li class="dropdown user-dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="${pageContext.request.contextPath}/settings/index.html"><span
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            ...
            <li class="liClass"><a href="${pageContext.request.contextPath}/toView/activity/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/toView/log/log" target="workareaFrame"><span
                    class="glyphicon glyphicon-tasks"></span> 日志管理 </a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/toView/clue/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-search"></span> 线索（潜在客户）</a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/toView/customer/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-user"></span> 客户</a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/toView/contacts/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-earphone"></span> 联系人</a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/toView/transaction/index" target="workareaFrame"><span
                    class="glyphicon glyphicon-usd"></span> 交易（商机）</a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/toView/visit/index" target="workareaFrame"><span
            ...
            <li class="liClass">
                ...
                <ul id="no2" class="nav nav-pills nav-stacked collapse">
                    ...
                    <li class="liClass"><a href="${pageContext.request.contextPath}/toView/chart/clue/index" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span
                    ...
                    <li class="liClass"><a href="${pageContext.request.contextPath}/toView/chart/transaction/index" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span
