    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar"
            ...
            <div class="btn-group" style="position: relative; top: 18%;">
                <button type="button" id="createClueBtn" class="btn btn-primary" data-toggle="modal"
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a style="text-decoration: none; cursor: pointer;"
                           href='${pageContext.request.contextPath}/workbench/clue/queryClueDetailById?id=4cc545ef207c48c292c987d23e1b1fe4'>李四先生</a>
                    </td>
                    <td>动力节点</td>
                    <td>010-84846003</td>
                    <td>12345678901</td>
...
<script>
    $('#createClueBtn').click(function () {
        ...
        //异步查询字典数据
        $.ajax({
            url: '${pageContext.request.contextPath}/dictionaryCache',
            type: 'get',
            dataType: 'json',
            success: function (data) {
                //先遍历所有的字典类型
    ...
    $('#saveClueBtn').click(function () {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/workbench/clue/saveClue',
            data: saveClueForm,
            type: 'post',
            dataType: 'json',
            success: function (data) {
